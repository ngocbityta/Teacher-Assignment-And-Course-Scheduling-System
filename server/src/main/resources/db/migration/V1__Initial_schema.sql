...
CREATE TABLE IF NOT EXISTS teaching_registrations (
    ...
    max_courses integer,
    CONSTRAINT uq_teachreg_teacher_semester UNIQUE(teacher_id, semester),
...
CREATE TABLE IF NOT EXISTS time_preferences (
    ...
    preference_value integer,
    CONSTRAINT uq_timepref_teacher_semester_day_period UNIQUE(teacher_id, semester, day, period),
...
CREATE INDEX IF NOT EXISTS idx_schedules_teacher_semester 
    ON schedules (teacher_id, semester);

CREATE INDEX IF NOT EXISTS idx_course_preferences_teacher_semester 
    ON course_preferences (teacher_id, semester);
